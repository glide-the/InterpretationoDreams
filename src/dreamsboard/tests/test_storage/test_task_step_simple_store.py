...
def test_simple_task_step_store_save_level():
    ...
    task_step2 = TaskStepNode.from_config(cfg={
        "start_task_context": "start_task_context",
        "aemo_representation_context": "aemo_representation_context",
        "task_step_name": "task_step_name",
        "task_step_description": "task_step_description",
    ...
    task_step3 = TaskStepNode.from_config(cfg={
        "start_task_context": "start_task_context",
        "aemo_representation_context": "aemo_representation_context",
        "task_step_name": "task_step_name",
        "task_step_description": "task_step_description",
    ...
    assert list(store_load.task_step_all.values())[0].__dict__ == list(store.task_step_all.values())[0].__dict__
    assert list(store_load.task_step_all.values())[1].__dict__ == list(store.task_step_all.values())[1].__dict__
    assert list(store_load.task_step_all.values())[2].__dict__ == list(store.task_step_all.values())[2].__dict__
