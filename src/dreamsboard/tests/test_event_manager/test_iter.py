...
def test_iteratorize():
    ...
    it = Iteratorize(func=sample_task, resource_id="Resource_1",sentinel=sentinel, resource_lock=resource_lock)
...
def test_iteratorize_threads():
    ...
    iterators = [
        Iteratorize(func=sample_task, resource_id=f"Resource_{i}", sentinel=sentinel, resource_lock=resource_lock)
