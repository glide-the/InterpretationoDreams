...
def test_structured_dreams_storyboard_store_test_glm4_9b(setup_log) -> None:
    llm = ChatOpenAI(
    ...
    try:
        ...
        storage_context = StorageContext.from_defaults(persist_dir="./ieAjabk1_keyframe")
    ...
    if not index_loaded:
        ...
        try:
            ...
            dreams_analysis_store = SimpleDreamsAnalysisStore.from_persist_dir(persist_dir="./ieAjabk1_keyframe")
        ...
        if not dreams_analysis_store_loaded:
            dreams_generation_chain = StoryBoardDreamsGenerationChain.from_dreams_personality_chain(
                llm_runable=llm, csv_file_path="ieAjabk1_keyframe.csv")
            ...
            dreams_analysis_store_path = concat_dirs(dirname="./ieAjabk1_keyframe", basename="dreams_analysis_store.json")
        ...
        builder = StructuredStoryboardCSVBuilder.form_builder(csv_file_path="ieAjabk1_keyframe.csv")
        builder.load()
