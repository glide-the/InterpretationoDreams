...
def test_create_structured_output_runnable2() -> None:
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ("system", """根据提供的故事场景，您作为心理咨询工作者可以使用开放性问题来引导患者表达他们的感受和思维。以下是一步一步的分解：
...
在这个故事场景中，你是否注意到了自己的情感变化或思维模式？有没有什么你想要深入探讨或解决的问题?|引导自我反思"""),
    ...
    out = chain.invoke({"input": """以下是如何通过分步引导患者张毛峰说出自己的问题的步骤：
