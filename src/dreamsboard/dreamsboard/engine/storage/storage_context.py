...
class StorageContext:
    ...
    def from_defaults(
        ...
        return cls(dreams_analysis_store, template_store, index_store)
    ...
    def persist(
        ...
        Args:
            ...
            :param fs:
            :param persist_dir:
            :param dreams_analysis_store_fname:
    ...
    def to_dict(self) -> dict:
        all_simple = (
                isinstance(self.dreams_analysis_store, SimpleDreamsAnalysisStore)
