...
def main():
    ...
    # 写入json文件
    with open("gemini_q_glm_a_finetuning_events_1152q_1710191088.258371.json", "w") as f:
        json.dump(json_data, f, indent=4, ensure_ascii=False)


def print_json():
    #     获取jsonl文件
    jsonl_file = "/home/dmeck/Documents/content/finetuning_events_10q_2023-11-30_170732.jsonl"
    jsonl_data = parse_jsonl_file(jsonl_file)
